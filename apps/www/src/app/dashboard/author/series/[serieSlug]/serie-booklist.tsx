...
import { BookDragOverlay } from "@/components/book-ordering/book-drag-overlay";
import {
	type PendingSwap,
	SwapConfirmDialog,
} from "@/components/book-ordering/swap-confirm-dialog";
import {
	Alert,
	AlertAction,
	AlertDescription,
...
export function SerieBooklist({ serie }: SerieBooklistProps) {
	...
	const handleDragEnd = (event: DragEndEvent) => {
		...
		setPendingSwap({
			book1: { slug: book1.slug, title: book1.title, order: book1.order },
			book2: { slug: book2.slug, title: book2.title, order: book2.order },
		});
	};
	...
	const handleConfirmSwap = () => {
		...
		swapBooks({
			book1: pendingSwap.book1.slug,
			book2: pendingSwap.book2.slug,
		});
	};
